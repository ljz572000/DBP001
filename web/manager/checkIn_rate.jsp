    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="#">各个酒店入住率查询<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item ">
...
<div class="container">
    <div class="row">
        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">酒店入住率查询</h4>
            <form class="needs-validation" action="../ManagerServlet?opttype=checkIn_rate" method="post" role="form">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="hotelId">酒店号</label>
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2018-2019 xxx连锁酒店</p>
