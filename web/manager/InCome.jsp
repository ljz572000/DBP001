...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">酒店客房收入情况查询</h4>
            <form class="needs-validation" action="../ManagerServlet?opttype=InCome" method="post" role="form">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="hotelId">酒店Id号</label>
                        <input type="text" class="form-control" id="hotelId" value="" name="hotelId" required>
